document.addEventListener("DOMContentLoaded", () => {
    ...
    // ============================================================
    // 1. CARGAR DATOS DE LA EMPRESA (Logo y Nombre)
    // ============================================================
    ...
    const nombreEmpresa = userData?.compName;
    const contenedorNombre = document.querySelector('.empresa-nombre');

    if (nombreEmpresa && contenedorNombre) {
        contenedorNombre.textContent = nombreEmpresa;
    }
